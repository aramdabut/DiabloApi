...
class _ljPlayer;
class _ljFallen : public _ljMonster
{
public:
	_ljFallen(_ljColMap* colmap, _ljRandomMap* randomMap, _ljPlayer* player);
	_ljFallen(_ljColMap* colmap, _ljRandomMap* randomMap, _ljPlayer* player, TileIndex index);
	virtual ~_ljFallen();
