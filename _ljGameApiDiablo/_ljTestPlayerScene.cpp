...
_ljTestPlayerScene::_ljTestPlayerScene()
{
}
...
void _ljTestPlayerScene::Loading()
{
	/*MyScene::Loading();
...
void _ljTestPlayerScene::SceneUpdate()
{
}

void _ljTestPlayerScene::MakeMap()
{
	Make3RoomsY();
...
void _ljTestPlayerScene::Make3RoomsY()
{
	// 상
...
void _ljTestPlayerScene::Make3RoomsX()
{
