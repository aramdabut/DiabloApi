...
class _ljPlayer;
class _ljZombie : public _ljMonster
{
public:
	_ljZombie(_ljColMap* colmap, _ljRandomMap* randomMap, _ljPlayer* player);
	_ljZombie(_ljColMap* colmap, _ljRandomMap* randomMap, _ljPlayer* player, TileIndex index);
	virtual ~_ljZombie();
