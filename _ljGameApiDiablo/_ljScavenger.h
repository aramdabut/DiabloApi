...
class _ljPlayer;
class _ljScavenger : public _ljMonster
{
public:
	_ljScavenger(_ljColMap* colmap, _ljRandomMap* randomMap, _ljPlayer* player);
	_ljScavenger(_ljColMap* colmap, _ljRandomMap* randomMap, _ljPlayer* player, TileIndex index);
	virtual ~_ljScavenger();
